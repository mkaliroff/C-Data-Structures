...
Description: Runs the scheduler. Please notice - only one schedular can run for one proccess.
...
Description: Stops the scheduler. In order to stop schedular asynchronous - 
